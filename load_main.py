...
Usage:
  python load_main.py                    # download latest bhav copy and load to Oracle
  python load_main.py --date 2025-03-07  # specific date (YYYY-MM-DD)
  python load_main.py --download-only    # only download, do not load
  python load_main.py --load-only <path> # only load from existing CSV
"""
import argparse
